...
%Redúcelo a 8 páginas o meto yo la tijera por donde pille - JJ

\usepackage[latin1]{inputenc}
\usepackage{graphicx,color,longtable,multirow,times,amsmath,url,subfigure}
...
%Tiene bastante errores de inglés. Deberías pasárselo a Carlos o a Paloma para que te lo revisaran - JJ

%Para recortar puedes hacer lo de siempre: resumir en una sola fórmula algunas como la 8 y la 9 
% Usa URLs cortos para que ocupen menos (por ejemplo, comopt--- ) - JJ
% paper title: Must keep \ \\ \LARGE\bf in it to leave enough margin.
\title{\ \\ \LARGE\bf Migration study on a Pareto-based island model for multi-objective ant colony optimization algorithms}

\author{A.M. Mora, P. García-Sánchez, J.J. Merelo, P.A. Castillo \thanks{Department of Architecture and Computer Technology, ETSIIT, CITIC, University of Granada, Spain, {\tt \{amorag,pgarcia,jmerelo,pedro\}@geneura.ugr.es} }}
...
\begin{figure*}[htp]
\begin{center}
\subfigure[Unidirectional topology]{\includegraphics[scale=0.2,angle=-90]{figures/attainment_unidirectional.eps}}
\subfigure[Bidirectional topology]{\includegraphics[scale=0.2,angle=-90]{figures/attainment_bidirectional.eps}}
\subfigure[Broadcast topology]{\includegraphics[scale=0.2,angle=-90]{figures/attainment_broadcast.eps}}
...
% Macho, aquí no se ve nada. O usas una forma de representarlos en la
% que se vean las diferencias o no representes estas superficies
% porque no se ve un carajo - JJ
...
% Aquí no se ve absolutamente nada. O la quitas o usas símbolos un poco más claros... - JJ
\end{center}
\end{figure}
...
\begin{figure}[htp]
\begin{center}
\subfigure[$HV$]{\includegraphics[scale=0.17]{figures/boxplot_hypervolume_gray.eps}}
\subfigure[$Spr$]{\includegraphics[scale=0.17]{figures/boxplot_spread_gray.eps}}
\subfigure[$\epsilon$]{\includegraphics[scale=0.17]{figures/boxplot_epsilon_gray.eps}}
\subfigure[$|PS|$]{\includegraphics[scale=0.17]{figures/boxplot_num_solutions_gray.eps}}
%\subfigure[$Time$]{\includegraphics[scale=0.17]{figures/boxplot_time_gray.eps}}
...
\begin{figure}[htp]
\begin{center}
\subfigure[$HV$]{\includegraphics[scale=0.2]{figures/tukey_hypervolume_topology.eps}
		\includegraphics[scale=0.2]{figures/tukey_hypervolume_mig_rate.eps}}
\subfigure[$\epsilon$]{\includegraphics[scale=0.2]{figures/tukey_epsilon_topology.eps}
		\includegraphics[scale=0.2]{figures/tukey_epsilon_mig_rate.eps}}
\subfigure[$Spr$]{\includegraphics[scale=0.2]{figures/tukey_spread_topology.eps}
		\includegraphics[scale=0.2]{figures/tukey_spread_mig_rate.eps}}
\subfigure[$|PS|$]{\includegraphics[scale=0.2]{figures/tukey_num_solutions_topology.eps}
		\includegraphics[scale=0.2]{figures/tukey_num_solutions_mig_rate.eps}}
\subfigure[$Time$]{\includegraphics[scale=0.2]{figures/tukey_time_topology.eps}
...
\subsubsection*{Acknowledgements} %mal truco este. Debería ser
                                %section. 
