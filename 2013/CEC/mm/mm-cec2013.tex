...
possible. 
% Antonio - puedes comentar en una frase qué estrategias usamos los
% humanos
% done - JJ
...
% No necesariamente, se pueden encontrar mejores soluciones más
% lentamente - JJ
...
\end{tabular}
\end{table*}
% Antonio - ¿por qué no pones esta tabla más cerca de donde la citas?
% Si se muestra antes en el artículo que el texto que explica algunas
% de las cosas que muestra no se entenderá...
% Está encima- JJ
...
% que puede confundir con el ejemplo que pones después en el que usas
% 'AABB' como código. ;) 
% Ya sí lo he puesto - JJ
is to find the hidden combination in as few steps as
possible, she is interested in obtaining as small a partition as
% Antonio - supongo que se pone 'she' por una cuestión de
% discriminación positiva, pero weno, yo pondría he/she en todo
% caso. :p
% Muchas letras - JJ 
...
% Antonio - ¿'the best one' qué? parece que te refieres a la
% 'combination'
% no, score - JJ
...
point, in speed,
% Antonio - the state of the art es qué? no será a todos los
% niveles... :D
% En todo, prácticamente - JJ
...
acceptable solution.  
% Antonio - lo que pone aquí no cuadra con el título, fijar un
% parámetro no es explorar parameter space...
% Cambiado el título - JJ
%
...
operator rates.  
% Antonio - yo no diría esto de to be published. Dí cómo se han
% obtenido y yastá. Así parece que este tiene algo más de chicha,
...
% Antonio - ¿puedes poner alguna tablilla con los resultados de
% Wilcoxon? Le daría también más 'cuerpo' al trabajo. :D
% Uf, para qué... - JJ
...
% Antonio - yo quitaría el admittedly. Hace que el lector repare en
% que Evo10 es peor. Lo mismo si no lo pones, se pasa más por alto. :D
...
% Antonio - ¿por qué pones las figuras y tablas tan lejos de donde las
% citas? :D
% JJ cambiada esta 
...
This work is supported by projects TIN2011-28627-C04-02 and
TIN2011-28627-C04-01 and -02 (ANYSELF), awarded by the Spanish
