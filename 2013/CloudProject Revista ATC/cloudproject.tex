...
\begin{document}
 \pagestyle{empty} %ESTO QUITA LOS N0‰3MEROS DE P0†9GINA
...
% si usas computaciÃ³n nube en el tÃ­tulo, Ãºsalo en todos sitios - JJ
% Por otro lado, dÃ­ cuÃ¡l era el objetivo del trabajo. No puedes
% limitarte a decir "distintas configuraciones de parÃ¡metros" si no
% explicas lo que son, ni para quÃ© sirven, ni siquiera por quÃ© has
% decidido usar computaciÃ³n nube. FERGU: Añadidos


\end{abstract}
\renewcommand\keywords{\textbf{Palabras clave }}
\keywords{Cloud Computing, Proyecto Fin de Carrera, Amazon EC2, Virtualización, MapReduce, Algoritmos Evolutivos}


\renewcommand\abstractname{Abstract}
\begin{abstract} This paper shows the final degree project ``A study of genetic algorithms in the cloud and the MapReduce model''. During the development of this project the usage and application of genetic algorithms in different Cloud Computing environments was investigated, such as MapReduce or virtualization. Different parameter configurations, such as the population size or crossover type, were launched in different instances of Amazon Web Services. Results show the effect of these parameters to the different types of used instances.
\end{abstract}
\renewcommand\keywords{\textbf{Keywords }}
\keywords{Cloud Computing, Final Degree Project, Amazon Ec2, Virtualization, MapReduce, EvolutionaryAlgorithms}
...
intercambio de conocimientos, creatividad y colaboración.  % madre mÃ­a, esta frase es de los 90!!!! - JJ - FERGU: No la he escrito yo, que conste ;)
...
% si son evidentes, Â¡no los digas! Â¡No metas mÃ¡s rollo de la cuenta! - JJ - FERGU: lo quito
Sentando estos principios en la sociedad actual, la motivación de este proyecto fin de
...
% no uses expresiones inglesas cuando hay una espaÃ±ola perfectamente
% vÃ¡lida. - JJ - FERGU: cambiado
\item Es ``Centrado en el usuario'': Una vez que tú eres un usuario conectado a la nube, cualquier cosa que haya almacenada allí - documentos, mensajes, 
...
\item Es ``Centrado en la tarea'': En vez de concentrarse en la aplicación y qué hacer, se centra en lo que necesitas y cómo la aplicación puede 
...
% Â¿No hay un estado del arte? Hay un artÃ­culo de Una-May O'Reilly en
% el Ãºltimo EvoStar sobre el tema - JJ
