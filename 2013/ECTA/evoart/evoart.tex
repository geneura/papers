...
\author{\authorname{ANONYMOUS\sup{1}}%P. Garc{\'i}a-S{\'a}nchez\sup{1}, J.J. Merelo\sup{1}, D. Calandria\sup{2}, A. B. Pelegrina \sup{3}, R. Morcillo, F. Palacio \sup{4}, R. H. Garc{\'i}a-Ortega \sup{4}}
...
of a test image. Processing has been integrated in the ANONYMOUS \cite{OSGILIATHANONYMOUS} 
...
Processing can be integrated with Java just by adding a {\em jar} (a Java library) to existing software. In this work, Processing has been integrated to an existent EA framework, ANONYMOUS \cite{OSGILIATHANONYMOUS}, a service-oriented framework based in Java that includes a lot of primitives and services for Evolutionary Computation. A new module called ANONYMOUS has been added to the publicly-available source code of ANONYMOUS (available in \url{http://www.ANONYMOUS.org}) under a LGPL License. Then, using the packages available in the Processing library the EA can generate individuals, manipulate images or extract information.
...
The used software and algorithms presented are Open Source under a GPL license, and can be obtained from ANONYMOUSWEB. %\url{http://www.osgiliath.org}.
