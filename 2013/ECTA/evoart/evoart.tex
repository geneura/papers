...
\author{\authorname{P. Garc{\'i}a-S{\'a}nchez\sup{1}, J.J. Merelo\sup{1}, D. Calandria\sup{2}, A. B. Pelegrina \sup{3}, R. Morcillo, F. Palacio \sup{4}, R. H. Garc{\'i}a-Ortega \sup{5}}
...
\keywords{Evolutionry Art, HSV, RGB, Processing}
...
\noindent This paper introduces an Evolutionary Algorithm that uses the Processing framework to generate images and to extract image information. %The advantages of this framework have been presented and we think that Evolutionary Art area can take advantage of them. 
