...
my $turno;
my @p1_planets; my @p1_ships;
my @p2_planets; my @p2_ships;
my @p3_planets; my @p3_ships;
my @p4_planets; my @p4_ships;
my $leer = 4;
...
while ($linea=<>){
	...
	if ($linea=~/Turn ([^ \n]*)/){
		...
		if($linea=~/Player 1: P1 - (true|false)-(\d*)\/(\d*)-(\d*)\/(\d*)/){
				push(@p1_planets,$3>0?$2/$3:0);
				push(@p1_ships, $5>0?$4/$5:0);
				$leer --;
				#print $2/$3 . "\n";
				#print $4/$5 . "\n";
		}elsif($linea=~/Player 1: P2 - (true|false)-(\d*)\/(\d*)-(\d*)\/(\d*)/){
				push(@p2_planets,$3>0?$2/$3:0);
				push(@p2_ships, $5>0?$4/$5:0);
				$leer --;
				#print $turno;
				#print " ";
				#print $2/$3 . "\n";
				...
				push(@p3_planets,$3>0?$2/$3:0);
				push(@p3_ships, $5>0?$4/$5:0);
				$leer --;
				#print $2/$3 . "\n";
				#print $4/$5 . "\n";
		}elsif($linea=~/Player 1: P4 - (true|false)-(\d*)\/(\d*)-(\d*)\/(\d*)/){
				push(@p4_planets,$3>0?$2/$3:0);
				push(@p4_ships, $5>0?$4/$5:0);
				$leer --;
				#print $2/$3 . "\n";
				#print $4/$5 . "\n";
		}
