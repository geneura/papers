...
\title{Revisiting volunteer browsed-based computing}
...
This paper presents performance measurements on the jsEO ({\em
  JavaScript Evolving Objects}, pronounce it yi-see-oh) system, which uses PHP and
...
\bibliography{ror-js,GA-general,geneura,volunteer}
