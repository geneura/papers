...
\author{V\'{\i}ctor M. Rivas\inst{1} \and Juan Juli\'{a}n Merelo\inst{2} \and Gustavo Romero L\'{o}pez\inst{2} \and Maribel Garc\'{i}a Arenas\inst{2}}
%
...
\email{vrivas@ujaen.es},\\ http://vrivas.es/\texttt{}
\and
Universidad de Granada, Granada, Spain}
% Antonio - ya sabes que es revisión ciega. ;D
...
\url{http://mootools.net}.  % deberías al menos mencionar otros
                            % frameworks como stackJS y por qué has
                            % elegido este. No me vale "porque es el
                            % que conozco" - JJ
...
%\url{http://goo.gl/WqTDyM}  % Hay que anonimizar los trabajos - JJ
\url{anonymo.us/url}
and it
...
\label{sec:method}
The experiments designed to test jsEO include two problems, being the first the 256-bit Royal Road function, while the second is solving a 128-terms equation. In others words, the first one is related to a bit-string chromosome problem, while the second deals with vector of floats. Both problems have been executed as synchronized tasks, and are available at %\url{http://goo.gl/3lJj8Q}.
