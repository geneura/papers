...
\numberofauthors{2}
 ...
 \alignauthor
 Juan-J. Merelo, Antonio M. Mora and P. de las Cuevas\\
...
The functional programming language Erlang could be a good choice because it provides the actor pattern concept for concurrency and the functional paradigm for general modeling, design and coding of solutions.
