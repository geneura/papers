...
\begin{abstract}
This paper shows the design and implementation of services for Evolutionary Computation in a Service Oriented Architecture. Services are developted taking into account design and technological restrictions. OSGiLiath, an implementation of an abstract Service Oriented Architecture for Evolutionary Algorithms is used to develop new services. 
\end{abstract}
