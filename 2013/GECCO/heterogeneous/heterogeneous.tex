...
\begin{figure}
\centering
\epsfig{file=images/evalsMMDP.eps, height=1in, width=1in}
\caption{Number of evaluations for MMDP problem.}
\end{figure}

\begin{figure}
\centering
\epsfig{file=images/timeMMDP.eps, height=1in, width=1in}
...
\begin{figure}
\centering
\epsfig{file=images/evalsOneMax.eps, height=1in, width=1in}
\caption{Number of evaluations for OneMax problem.}
\end{figure}

\begin{figure}
\centering
\epsfig{file=images/timeOneMax.eps, height=1in, width=1in}
\caption{Time to obtain the result.}
\end{figure}
