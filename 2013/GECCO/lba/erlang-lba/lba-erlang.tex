...
% 2nd. author
\alignauthor
Juan-J. Merelo, Antonio M. Mora, Paloma de las Cuevas\\
...
Genetic algorithms, as many computational models, tend to be described in literature on its operational and imperative way. Their implementation in a functional language must follow a different path, structuring the algorithm model in less imperative and more declarative terms. We are going to use a parallel pool based evolutionary strategy\cite{DBLP:conf/3pgcic/GuervosMFEL12} as use case in order to show our mean. 
