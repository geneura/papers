...
compares two combinatios, be it the hidden combination with the one
...
optimization; however, it is almost imposible to go further using
...
Perl module and is available from CPAN at \url{http://hidde.nu.rl}.
...
version in Figure \ref{fig:profile:post}.  This new funtion takes
...
also an importan target for optimization, because it takes a lot of
...
the fastest sort function available in the Perl module respository
(called CPAN). 

%
\begin{figure*}[!htb]
\centering
\includegraphics[scale=0.5]{post-profile.png}
\caption{Output of {\tt Devel::NYTProf} after the last optiization
...
\caption{Comparison among approaches in this paper:  Evo
  and Berghman et al. \cite{Berghman09}. Previously obtained results
...
\textsc{FastEvoEntropy}   &  (768,32) $ 5.6148 \pm 0.011$ &  \\
                                               &  (768,256) $ 5.59 \pm 0.012$ &  \\
                                               & (1024,256) $5.577 \pm $ & (2048,256) $6.42\pm 0.011$\\
\textsc{FastEvoEntropy} S+SH & (800, 256) $5.5762 \pm $ & (1024,256) $6.43 \pm 0.12$\\

\hline
\end{tabular}
}

\subfloat[Mean number of evaluations with standard deviation;
...
\textsc{FastEvoEntropy}    &  (768,32) $ 12679 \pm 73$ &  \\
                                                &  (768,256) $ 25167 \pm 141$ &  \\
                                                & (1024,256) $29279 \pm 161$ & \\
\textsc{FastEvoEntropy} S+SH & (800, 256) $25488 \pm 144 $ & \\
\hline
\end{tabular}
}
...
%\textsc{Evo++ (EN) }   &  $ 26098 \pm 144$ & $67521 \pm 384$ \\
%\textsc{Evo++ (MP) }   & $20120 \pm 114$ & $68860 \pm 406$ \\
\textsc{FastEvoEntropy}   &  (768,32) $ 0.709 \pm 0.004$ &  \\ 
                                               &  (768,256) $ 3.03 \pm 0.02$ &  \\
                                                & (1024,256) $ 3.26 \pm 0.02$ & \\
\textsc{FastEvoEntropy} S+SH & (800, 256) $2.93 \pm 0.02 $ & \\
\hline
\end{tabular}
}
