...
combination in a permutation was extermely slow (since it had to
...
characters in the string tha shuffles it; the second one substitutes
...
it was not the main objettive of this paper, which was to establish a
...
significative using Wilcoxon t-test, and that is so for all methods
...
version of the method, as is isual, achieves the best results with a
sizeable population and CS=256. However, increasing more the
...
multithreaded applications to simulate parallel execution within a
