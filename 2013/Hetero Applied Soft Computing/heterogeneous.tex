...
\author[ugr]{Maribel García Arenas}
\ead{maribel@ugr.es}
...
\caption{Island model scheme using a ring topology.}
\label{fig:islands}
...
limited memory (and swapping) requires more time than iteration of
