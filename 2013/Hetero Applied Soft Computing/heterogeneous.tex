...
Furthermore, changing the population size affects to stages
...
to the average number of generations for the homogeneous parameter set as an 
offline parameter setting. \textcolor{red}{Moreover, a possible way to adapt 
online the population sizes is performed comparing the current generation with
...
nodes. Other benchmarks to analyse the algorithm will be also used to lead to automatic
