...
more efficient on heterogeneous hardware configurations than on clusters with
...
\textcolor{red}{With respect to AdSi/HeHa, results are significantly  equal (p-value 0.139) to HeSi/HeHa (and, therefore, better than HoSi/HeHa).  Average population sizes in each node are shown in Table \ref{table:sizesMMDP}. The proportion of sizes are similar to the proportions in Table \ref{table:generations}. Figure \ref{fig:sizesMMDP} shows all the possible sizes in each node during all the runs. This figure show that the variation of the population sizes RECAE proportionally to the computational power of each node. The outliers in boxplots are produced during the size changing, as can be seen in Figure \ref{fig:adsiMMDP1ejec}.}
...
\begin{table*}
\centering{
\caption{Average population size in each node on the heterogeneous cluster with adaptative size (MMDP).}
\begin{tabular}{|c|c|c|c|c|} \hline
Node        & HeN1     & HeN2      & HeN3     & HeN4   \\ \hline
...
\begin{table*}
\centering{
\caption{Average population size in each node on the heterogeneous cluster with adaptative size (OneMax).}
\begin{tabular}{|c|c|c|c|c|} \hline
Node        & HeN1     & HeN2      & HeN3     & HeN4   \\ \hline
