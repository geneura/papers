...
is used. For example, in the work of Garamendi et al. \cite{PARALLELIMPLEMENTATION} 
where a small benchmark was executed in all nodes at the beginning of the algorithm
 ...
 (ES). The computational load by artificial benchmarks may not accurately 
...
Appart from order the nodes taking into account 
...
The heterogeneous computational performance of nodes or network speed can affect the performance of an algorithm. In \cite{HETEROGENEOUSHARD},
 ...
 the sub-types of EAs, on homogeneous and heterogeneous clusters. % ¿Cómo considera las prestaciones un parámetro este trabajo en particular? - JJ FERGU2: number of iterations
