...
\titlerunning{Evolving strategies for ANTS game\footnote{This work has been funded in part by PROJECTS}}
%
...
this paper we have evolved this engine off-line by means of a GA, % antes has usado EA, ahora GA. Comprueba todo el paper para que sea uniforme. - JJ
used
for tuning a set of constants, weights and probabilities which direct
...
our simple agent tuned with a GA can sometimes outperform agents which
have finished 1000 positions above it. 
...
% quedaron por encima del original - JJ
\end{abstract}
...
% Pero ten cuidado a ver si lo has repetido veinte veces - JJ
