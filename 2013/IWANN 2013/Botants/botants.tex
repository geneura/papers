...
%
\author{J. Carpio\inst{1}, P. Garc\'ia-S\'anchez\inst{2}, A.M. Mora\inst{2}, J.J. Merelo\inst{2}, J. Caraballo\inst{1}, F. Vaz\inst{1}, C. Cotta\inst{3}}
%
%
...
\begin{abstract}
This work studies the performance and the results of the application of Evolutionary Algorithms (EAs) for evolving the decision engine of a program, called in this context \textit{agent}. This game was chosen for the Google Artificial Intelligence Challenge in 2011, and simulates battles between teams of ants in different types of maps without saving information between games. This restriction makes unable to implement an Evolutionary Algorithm inside the agent.  
...
The results show that, although the best agents are difficult to win, a very simple agent tuned with the GA is possible to beat the agent that finished 1000 positions above it.
