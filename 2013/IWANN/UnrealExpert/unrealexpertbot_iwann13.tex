...
\author{A.M. Mora\inst{1} \and F. Aisa\inst{1} \and R. Caballero\inst{1} \and P. García-Sánchez\inst{1} \and \\ J.J. Merelo\inst{1} \and P.A. Castillo\inst{1} \and A.J. Fernández-Leiva\inst{2}}
...
\begin{figure}[htb]
   \centering
   \includegraphics[scale=0.3]{imags/exp1_c143-30g-30i-15min.eps}
...
\begin{figure}[htb]
   \centering
   \includegraphics[scale=0.3]{imags/exp3_c26-50g-30i-5mins-1.eps}
   \includegraphics[scale=0.3]{imags/exp3_c26-50g-30i-5mins-2.eps}
...
\begin{figure}[htb]
   \centering
   \includegraphics[scale=0.3]{imags/exp4_c26-50g-30i-5mins-fitcomplex-1.eps}
   \includegraphics[scale=0.3]{imags/exp4_c26-50g-30i-5mins-fitcomplex-2.eps}
...
This paper has been funded in part by project TIN2011-28627-C04-02 (ANYSELF), projects P08-TIC-03903 (EVORQ) and P10-TIC-6083 (DNEMESIS) awarded by the Andalusian Regional Government, and project 83 (CANUBE) awarded by the CEI-BioTIC UGR.
