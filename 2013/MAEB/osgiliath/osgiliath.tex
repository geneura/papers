...
% Muchos servicios me parecen ¿Resolviendo problemas? ¿Creando aplicaciones? ¿Desarrollo ágil? - JJ
...
servicios interoperables teniendo en cuenta esas restricciones. % ¿Cuál es el objetivo del trabajo? ¿Lo has cumplido? ¿Qué resultados has obtenido? - JJ

\end{abstract}


% Creo que el límite son 10 páginas, ¿no? - JJ
...
\item Los servicios deben ser diseñados tan abstractos como sea
  posible. % ¿a un nivel de abstracción adecuado? - JJ
\end{itemize}
...
% ¿nuestro trabajo? ¿No se anónimo? - JJ 
...
lograr más independencia y mejoras en el desarrollo. % Por eso
                                % nosotros ... - JJ
...
% Esto podías suprimirlo si te falta espacio - JJ
\label{fig:ds}
\end {figure*}
...
% nada más? ¿Cuanto tiempo? ¿Cuantas líneas de código? ¿Algo? - JJ
