...
Este trabajo propone una representación metafórica para visualizar dinámicamente los elementos del código de un programa. La metáfora utilizada está basada en técnicas de gamificación. La idea es hacer más atractiva la tarea de codificación en programación. Para ello se utilizan videojuegos de plataformas. El uso de las estructuras de control básicas de un programa se corresponden con plataformas o elementos del videojuego por los que el personaje principal se mueve. Esta metáfora resulta muy intuitiva y relaciona ambos contextos. En concreto, los elementos que pueden ser representados incluyen las sentencias de control típicas como un condicional, los bucles y el retorno. 
...
\item {\em Bucle}: Es representado mediante una tubería por donde el personaje se introduce y aparece al principio del bucle.
\item {\em Retorno}: Una puerta representa la salida del método.
\end{itemize}

Existen multitud de videojuegos de plataformas que cumplen con estos requisitos. En este aspecto la visualización puede ser personalizada por el usuario para elegir los gráficos relacionados con el juego que le resulte más atractivo. 



(tabla de figuras de elementos programación)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  DETAILS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{Implementación}

La implementación de esta propuesta está realizada sobre el entorno de desarrollo Eclipse. Eclipse es una herramienta multipropósito fácilmente extensible gracias a su arquitectura de plugins basada en OSGi. OSGi permite construir sistemas software de calidad considerando un alto nivel de modularidad. Además de los beneficios que los paradigmas clásicos de modularización ofrecen (como el modelado orientado a objetos) y las mejoras en testeo, reusabilidad, disponibilidad y mantenibilidad, es necesario explorar otras técnicas, como el desarrollo basado en plug-ins o el diseño SOA. Este tipo de desarrollo simplifica aspectos como la complejidad, personalización, configuración, y coste del desarrollo.

(figura de arquitectura de plugins de eclipse)
