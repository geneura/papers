...
(figura de programa y diagrama de flujo asociado)
...
(figura de conjuntos, funciones y vectores)
...
(figura de ecuación con paréntesis y programa de Lisp)
...
(figura de diagrama de flujo, diagrama de clases)
