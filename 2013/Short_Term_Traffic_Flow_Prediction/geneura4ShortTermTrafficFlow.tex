...
As figure \ref{fig:weekly} shows, the number of BT devices detected clearly varies from weekdays to weekends; although the figur shows the sum of the 5 nodes, this charasteristics is also observed in every single node.
