...
% muy d�bil esa afirmaci�n �Lo parece o lo es? �A quien le parece?
...
% de d�nde es ese dato? Tratad de haced afirmaciones siempre sober
% alg�n dato publicado - JJ
...
percentage of users. % �Y de d�nde hab�is sacado eso? Adem�s, el
                     % experimento est� hecho sobre calles, no s�lo
                     % carreteras. - JJ
...
\label{sec:soa}
This section introduces the two techniques used in this work. On the
one hand, the methods developed to detect traffic flows; and on the
other hand, algorithms and techniques suitable to be used for
