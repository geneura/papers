...
In this work, an information system of the traffic status is proposed. This information system is based on data collected by means of bluetooth (BT) device discovery, and provides description of the current traffic conditions, as well as a valuable dataset suitable to be used in a time-series forecasting process.
...
Therefore, from the transport management viewpoint, various needings have been found:
...
For this work, the data collected by 5 nodes during 60 days have been used. First day corresponds to November 24, 2011, while last day corresponds to January 22, 2013. Figure \ref{fig:collected-data} shows the ammount of BT devices detected by each node along this period. Nodes 4 and 5 are shown in a separate graphics since they were located in a highway, so that they registered a higher number of BT devices.
\begin{figure}[htb]
 \begin{center}
