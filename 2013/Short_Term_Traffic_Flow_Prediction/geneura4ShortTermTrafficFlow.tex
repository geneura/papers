...
\begin{tabular}{|cccc|}
\hline
$Ranking$&Method&$p$& Null Hypothesis\\
\hline
1&ARIMA&0.176&Accepted\\
2&MEAN&0.028& Rejected \\
3&THETA&0.007& Rejected \\
4&CROSTON&0.007& Rejected \\
5&SPLINE&2.003E-4& Rejected \\
\hline
\end{tabular}
\end{center}
\caption{Results of the Holm's procedure applied to error MAE. L-co-R does not appear in the table as it is the best, and consequently, control algorithm. Values of $p$ under $0.05$ lead to reject the null hypothesis, i.e., the forecasting provided by L-Co-R and the corresponding algorithm can be considered significantly differents.
\label{tb:holm-mae}}
...
\hline
\emph{Error} & \emph{Best algorithm} & \emph{No significant differences} & \emph{Significant differences} \\
\hline
\emph{MAE} & (1) L-Co-R & (2) ARIMA, 

(3) Mean & (4) Theta, (5) Croston, (6) Spline \\
\emph{MAPE} & (1) L-Co-R& (2) ARIMA, (3) Mean, (4) Theta & (5) Croston, (6) Spline  \\
\emph{MASE} & L-Co-R & Arima, Mean, Theta, Croston & Spline  \\
\emph{MdAPE} & L-Co-R & Arima, Mean & theta, Spline, Croston  \\
\emph{MSE} & (1) ARIMA & (2) L-Co-R, (3) MEAN, (4) Croston, (5) Theta & (6) Spline \\
\emph{SMAPE} & (1) ARIMA & (2) L-Co-R, (3) MEAN, (4) Croston, (5) Theta & (6) Spline \\
\hline
...
\emph{MAE} & \emph{MAPE} & \emph{MASE} & \emph{MdAPE} & \emph{MSE} & \emph{SMAPE} \\
\hline
\textbf{L-Co-R} & \textbf{L-Co-R} & \textbf{L-Co-R}  & \textbf{L-Co-R}  & \textbf{ARIMA}  & \textbf{ARIMA}  \\
\textbf{No diff.} & \textbf{L-Co-R} & \textbf{L-Co-R}  & \textbf{L-Co-R}  & \textbf{ARIMA}  & \textbf{ARIMA}  \\

\textbf{ARIMA} & \textbf{ARIMA} & \textbf{ARIMA}  & \textbf{ARIMA}  & \textbf{L-Co-R}  & \textbf{L-Co-R}  \\
\textbf{Mean} & \textbf{Mean} & \textbf{Mean} & \textbf{Mean} & \textbf{Mean} & \textbf{Mean} \\
Theta & \textbf{Theta} & \textbf{Theta} & Theta & \textbf{Croston} & \textbf{Croston} \\
Croston & Croston & \textbf{Croston} & Spline & \textbf{Theta} & \textbf{Theta} \\
Spline &Spline &Spline &Spline &Croston &Spline \\
%\emph{MAE} & (1) L-Co-R & (2) ARIMA, (3) Mean & (4) Theta, (5) Croston, (6) Spline \\
%\emph{MAPE} & (1) L-Co-R& (2) ARIMA, (3) Mean, (4) Theta & (5) Croston, (6) Spline  \\
%\emph{MASE} & L-Co-R & Arima, Mean, Theta, Croston & Spline  \\
%\emph{MdAPE} & L-Co-R & Arima, Mean & theta, Spline, Croston  \\
%\emph{MSE} & (1) ARIMA & (2) L-Co-R, (3) MEAN, (4) Croston, (5) Theta & (6) Spline \\
