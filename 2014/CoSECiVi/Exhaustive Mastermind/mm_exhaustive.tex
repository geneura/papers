...
\title{New Exhaustive solutions to the Game of MasterMind}
% a short form should be given in case it is too long for the running head
\titlerunning{Exhaustive solutions to Mastermind}

\author{J.J. Merelo\inst{1}, A.M. Mora\inst{1}, T.P. Runarsson\inst{2}, C. Cotta\inst{3}}
\authorrunning{J.J. Merelo et al.}

\institute{
Departamento de Arquitectura y Tecnología de Computadores. \\
ETSIIT-CITIC, Universidad de Granada (Spain).\\
\email{\{amorag,jmerelo\}@geneura.ugr.es}\\
\and
...
MasterMind is a board game that has enjoyed
...
consistent set is practically the same as for Entropy. However,
...
advantage of one algorithm over another, and that studying mainly
...
\section*{Acknowledgments}
 ...
 Spanish Ministry of Science and Innovation and P08-TIC-03903 awarded by the  Andalusian Regional Government, and PYR-2014-17 included in GENIL - CEI BIOTIC (Granada).
