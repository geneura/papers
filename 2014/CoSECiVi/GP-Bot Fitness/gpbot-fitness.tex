...
\begin{abstract}
This paper presents a Genetic Programming application to the design of behavioural engines for autonomous agents (bots) which play 1 vs 1 battles in the RTS Planet Wars.
