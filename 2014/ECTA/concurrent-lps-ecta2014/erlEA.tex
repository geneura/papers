...
We developed a library in Erlang following the previous design concepts and it was tested with the case study. The code is open, under AGPL license, at %\url{https://github.com/jalbertcruz/erlEA/archive/v1.0.tar.gz}
