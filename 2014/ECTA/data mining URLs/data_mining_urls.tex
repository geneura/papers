...
\noindent Although Data Mining (DM) and Machine Learning (ML)
techniques have been used since long ago in many scientific fields,
and given that research in computer security was growing since the
eighties \cite{computer_security_80}, it was not until the nineties
that these techniques began to be applied to security issues
