...
The results derived from the experiments (described in Section \ref{sec:results}) show that this quantity of data might be enough, but a more accurate outcome would be given with, for instance, a 24 hours long log.
