...
the security assurance % assurance? qué significa eso? - JJ
 inside them \cite{Opp_Security11}, has meant % the new scenario
                                % ... has meant - JJ
the arisen % the arisen! the afallen! Diablos, revisad esto!!!! - JJ
 of new security issues , which should be dealt in a different way, normally by means of \textit{Corporate Security Policies}.
...
One of the main breaches regarding % primer regarding - JJ
...
In this work we try to define a tool for automatically made % for
