...
% eso lo harías si se tratara simplemente de
...
% Uno de los problemas principales de los trabajos previos, es el elevado tiempo de cómputo necesario para la evaluación de los agentes, igual se podría justificar por ahí - Antares
...
with regard the fitness convergence, as it was expected. Moreover, the
best bot obtained is a better opponent than our previous `champion',
...
, using an regular Genetic Algorithm (GA) \cite{GAs_Goldberg89}. We
