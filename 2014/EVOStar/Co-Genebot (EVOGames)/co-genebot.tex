...
%This work has been supported by the regional projects TC-3928 and TIC-03903 (Feder Funds), the Spanish projects TIN 2012-33856 (Feder Funds), and TIN 2011-2-C04-02 (Feder Funds). The authors would also like to thank the FEDER of European Union for financial support via project "Sistema de Información y Predicción de bajo coste y autónomo para conocer el estado de la carreteras en tiempo real mediante dispositivos distribuidos" (SIPEsCA) of the "Programa Operativo FEDER de Andalucía 2007-2013". We also thak all Agency of Public Works of Andalusia Regional Goverment staff and researches for their dedication and professionalism.
