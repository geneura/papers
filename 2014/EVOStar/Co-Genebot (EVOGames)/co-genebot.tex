...
\begin{figure}[H]
    ...
    \begin{subfigure}[H]{0.6\textwidth}
        \begin{center}
            \epsfig{file=imagenes/2G-turnos_all.eps,width=1\textwidth}
            \epsfig{file=imagenes/2G-pendiente_all.eps,width=1\textwidth}
            \epsfig{file=imagenes/2G-area_all.eps,width=1\textwidth}
        \end{center}
    ...
    \begin{subfigure}[H]{0.6\textwidth}
        \begin{center}
            \epsfig{file=imagenes/4G-turnos_all.eps,width=1\textwidth}
            \epsfig{file=imagenes/4G-pendiente_all.eps,width=1\textwidth}
            \epsfig{file=imagenes/4G-area_all.eps,width=1\textwidth}
        \end{center}
...
\end{center}
\caption{Place finish in 500 simulations against 3 very tough opponents for each method.}
...
\begin{figure}[H]
    ...
    \caption{Best bot of each fitness execution, versus other fitness methods in same knowledge type}
\end{figure}
...
\tiny
\begin{center}
  \includegraphics[width=0.85\textwidth]{"imagenes/todos_contra_todos"}
\end{center}
