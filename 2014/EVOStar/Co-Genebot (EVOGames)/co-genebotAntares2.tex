...
Different experiments are development to studies each part of this paper. The principal experiment is improve bots using the co-evolutionary algorithm. The parameters uses in the Co-GA are show in table in Fig.\ref{tabla:GA}
...
For each previously presented method, at least 3\footnote{GA generally requires more executions, but executions are costly in time in our problem.} executions of the Co-GA.
...
\begin{figure}[h]
    ...
    \begin{subfigure}[H]{0.6\textwidth}
        \begin{center}
            ...
            \epsfig{file=imagenes/2G-pendiente_all.eps,width=1\textwidth}          \epsfig{file=imagenes/2G-area_all.eps,width=1\textwidth}
        \end{center}
        \caption{Methods with previous knowledge}
        \label{equation:LeatsSqueares}
    \end{subfigure}
    \begin{subfigure}[H]{0.6\textwidth}
        \begin{center}
            \epsfig{file=imagenes/4G-turnos_all.eps,width=1\textwidth}             \epsfig{file=imagenes/4G-pendiente_all.eps,width=1\textwidth}          \epsfig{file=imagenes/4G-area_all.eps,width=1\textwidth}
        \end{center}
        \caption{Methods with autogenerate knowledge}
        \label{equation:LeatsSqueares}
    \end{subfigure}
\end{figure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[H]{0.6\textwidth}
        ...
        \label{equation:LeatsSqueares}
    \end{subfigure}
    \caption{Best bot of each fitness execution, versus other fitness methods}
\end{figure}
...
More experiments are needed... Working in it!

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  CONCLUSIONS  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\section{Conclusions and Future Work}
\label{sec:conclusions}
Co-evolution takes less time of exection.
