...
%     %%%%%%%%%%   AUTHORS   %%%%%%%%%%
%
%\author{F. Liberatore, A.M. Mora, J.J. Merelo, P.A. Castillo}
%\authorrunning{F. Liberatore \emph{et al.}}
%\institute{
%Departamento de Arquitectura y Tecnología de Computadores. \\
%CITIC-UGR, ETSIIT. \\
%University of Granada, Spain \\
%\email{federico.liberatore@urjc.es, amorag@geneura.ugr.es, jmerelo@geneura.ugr.es, pacv@ugr.es}
%}
...
\STATE \COMMENT{Translate the steering force in a ranking for the next ghost direction.}
