...
To test each individual during the evolution a battle with a previously created bot is performed in 5 different (but representative) maps provided by Google. The fitness used is a hierarchichal one previously used by other researchers in \cite{}. In our case, an individual is better than another if it wins in more maps. In case of equality then the individual with more turns to be defeated (i.e. it is stronger) is considered better. Also, as proposed by \cite{}, and due to the noisy fitness effect, in every generation all individuals are re-evaluated.


Two publicly available bots have been chosen for our experiments. The first bot to confront is {\em GeneBot}, proposed in the work \cite{Mora2012Genebot}. This bot was trained using a GA to optimize the 8 parameters that conforms a set of hand-made rules. The other chosen bot is an advanced version of the previous one, called {\em ExGenebot} presented in \cite{FernandezAres2012adaptive}. This bot outperformed Genebot widely. ExGenebot bot analyses the distribution of the planets of the map to chose a previously optimized set of parameters. 

After executing out algorithm without tree limitation in depth we also have executed with the lower and average levels obtained for the best individuals: 3 and 7, respectively, to study if this number has any effect in the results.   Table \ref{tab:parameters} summarizes all the parameters used.
...
After all the executions we have evaluated all the obtained best individuals in all runs confronting to the bots in a larger set of maps (the 100 maps provided by Google) to study the behaviour of the algorithm and the obtained bots.
...
Table \ref{tab:results} summarizes all the obtained results of the execution of our EA. This table also shows the average age, depth and number of nodes of the best individuals obtained and also the average population at the end of the run. The average turns columns are calculated only taking into account the individuals with lower victories than 5, because this number is 0 is they have win the five battles.
...
\end{table*}
            ...
            & 3                   & Unlimited             &              3        &       7                 & UNLIMITED
 Victories  &  4.933$\pm$ 0.25    & 4,9     $\pm$ 0.30    &  4.133   $\pm$ 0.50   & 4.2      $\pm$ 0.48    & 4.4     $\pm$ 0.56 
 Turns      & 244.5 $\pm$  54.44  & 266,667 $\pm$ 40.42   &  221.625 $\pm$ 54.43  & 163.667  $\pm$ 106.38  & 123.533 $\pm$ 112.79 
 Victories  &  4.486$\pm$ 0.52    & 4,711   $\pm$ 0.45    &  3.541   $\pm$ 0.34   & 3.689    $\pm$ 0.37    & 4.043   $\pm$ 0.38 
 Turns      & 130.77$\pm$ 95.81   & 190,346 $\pm$ 102.92  &  200.086 $\pm$ 50.79  & 184.076  $\pm$ 57.02   & 159.094 $\pm$ 61.84 
 Best       & 3     $\pm$ 0       & 6,933   $\pm$ 4.05    &  3       $\pm$ 0      & 5.2      $\pm$ 1.84    & 6.966   $\pm$ 4.44 
 Population & 3     $\pm$ 0       & 7,353   $\pm$ 3.11    &  3       $\pm$ 0      & 5.216    $\pm$ 0.92    & 6.522   $\pm$ 1.91 
 Best       & 7     $\pm$ 0       & 22,133  $\pm$ 22.21   &  7       $\pm$ 0      & 12.6     $\pm$ 6.44    & 18.466  $\pm$ 15.46 
 Population & 7     $\pm$ 0       & 21,418  $\pm$ 13.81   &  7       $\pm$ 0      & 13.05    $\pm$ 3.92    & 16.337  $\pm$ 7.67 
 Best       & 8.133 $\pm$ 3.95    & 5,066   $\pm$ 2.11    &  4.266   $\pm$ 5.01   & 4.133    $\pm$ 4.26    & 4.7     $\pm$ 4.72 
 Population & 4.297 $\pm$ 3.027   & 3,092   $\pm$ 1.27    &  3.706   $\pm$ 0.58   & 3.727    $\pm$ 0.62    & 3.889   $\pm$ 0.71  
