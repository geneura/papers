...
The proposed agent receives a tree to execute
...
The fitness used is defined

The selected bot to confront is GeneBot, proposed in our previous work \cite{Mora2012Genebot}.
