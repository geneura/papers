...
% (FERGU): Quitar todos los "it's" mal puestos
% (Rubén): Done

% (FERGU): Poner bien las comillas, así: ``yeja''
% (Rubén): Done

% (FERGU): No hablar de los logs y las cosas técnicas que permitan integración (o sea, poca ingeniería). Lo de las expresiones regulares tampoco nos interesa demasiado, lo importante son los resultados
% (Rubén): TODO

% (FERGU): Sí, da las gracias a la fundación al final (pero ahora es anónimo!)
% (Rubén): ok TODO

% (FERGU): Si es para EvoGames no podemos decir literario, y viceversa (tendríamos que quitar lo de Skyrim por ejemplo)
% (Rubén): TODO estudiar

% (FERGU): Enlazar mejor lo de antes de "In this work, several..."
% (Rubén): TODO

% (FERGU): Sí que creo que habría que decir las características que tiene un perfil, nombrarlas al menos o decir su número (para saber el tamaño de los individuos del EA).
% (Rubén): TODO

% (FERGU): Quitar la figura lifecyle y decir que no nos cabe, pero que se puede bajar del github. Demasiada información y no se va a ver...
% (Rubén): Jopeta!

% (FERGU): shows the average of the best fitness and the average of the average fitness for 30 executions ---> shows the average of the best fitness and the average population fitness at the end of each execution
% (Rubén): Done

% (FERGU): Results for 30 executions of each configuration for 1 to 5 profiles --> using 1 to 5 profiles.
% (Rubén): Done

% (FERGU): Decir en algún lado, que el tamaño del individuo entonces también varía (no es lo mismo un individuo de 1 perfil que tendrá 12 parámetros que uno de 5 que tendrá 60)
% (Rubén): TODO

% (FERGU): set-up -> setup
% (Rubén): Done

% (FERGU): Hay que dejar claro que es cada cosa: perfil y características y seguir la misma nomenclatura para que la gente no se pierda. Aquí el ejemplo: The MADE Agent is created using 12 parameters --> ... using 12 parameters, that is, its profile.
% (Rubén): TODO

% (FERGU): Hay que poner una gráfica de cómo va la evolución del fitness con 1..5 perfiles
% (Rubén): TODO
...
In videogames, NPCs (Non Player Characters)  are a type of characters
...
% FERGU: Esto lo he quitado, quizás habría que poner "Nuestro trabajo es nuevo en cuanto a que nosotros..."
...
% C�mbialo por un algoritmo. Ocupa demasiado espacio y no se ve nada. 
...
\item Emergence of the \textit{downtrodden} archetype in the 22\% of
  the % Corregido este, corrige t� los otros. No s� si se puede
      % hablar de emergencia, puesto que lo has puesto t� a g�evo - JJ
...
% (JJ): Tienes que justificar todos estos números. 
% (Rubén): ok
...
\subfigure[Experiment 1]{
   \includegraphics[width=13.5pc] {img/exp1.pdf}
   \label{fig:subfig1}
 }
\subfigure[Experiment 2]{
   \includegraphics[width=13.5pc] {img/exp2.pdf}
   \label{fig:subfig2}
 }
...
\subfigure[Experiment 1]{
   \includegraphics[width=13.5pc] {img/graph1.pdf}
   \label{fig:evo1}
 }
%Est� el pie bien en esta? - JJ
\subfigure[Experiment 2]{
   \includegraphics[width=13.5pc] {img/graph2.pdf}
   \label{fig:evo2}
 }
\caption{Example of the evolution of the best individual for the five
  profiles for each configuration.}
% �Qu� hay que ver aqu�? Comparar un n�mero de perfiles con otro? - JJ 
...
%Lo m�s importante: responde a las preguntas que te has planteado? - jj
