...
% (Rubén): TODO For example, we could define that a 


% (Rubén): TODO ... Nuestra propuesta consiste en mapear los parámetros a un cromosoma y evolucionar la solución mediante un GA utilizando como fitness el número de agentes de la ejecución de entorno made que muestran los comportamientos deseados definidos por los patrones a alto nivel.
