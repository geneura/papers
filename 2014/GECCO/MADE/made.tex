...
allows empathize  % mal escrito, y Â FERGU: arreglado. SÃ­, existe.¿existe empathize? - JJ
...
The rest of the work is structured as follows: after the state of the art, the proposed methodology is presented in Section \ref{sec:methodology}. Then, an application of the methodology, with experiments conduced with the EA are shown (Section \ref{sec:appliying}). Finally, conclusions and future works are discussed.
