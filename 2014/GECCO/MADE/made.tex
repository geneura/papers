...
The present methodology is focused on \textit{generating a setting}
...
In our approach, the mood of the setting will be modeled as a group of abstract archetypes and different conditions over them.
...
Each agent has to be modeled as a Finite State Machine (FSM) whose transitions generate symbols in a language that includes dates, actions, direct and indirect objects.
...
Table~\ref{fig:exp1_30ex} shows the average of the best fitness and the average population fitness
%at the end of 30 executions for each configuration: number of profiles from 1 (P1) to 5 (P5) 
in the experiment 1 (``territorial war''). Boxplots of the best fitness obtained are shown
in Figure \ref{fig:subfig1}.
