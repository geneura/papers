...
\item Could this methodology be exported to be used in a bigger task such as creating a literary piece or work?
\end{itemize}
...
enriched. In this respect, Story Generation Systems like Tale-Spin\cite{talespin}, Universe\cite{universe}, Minstrel\cite{minstrel} or Virtual Story Teller\cite{virtualstoryteller} are more aligned with our goal, since they are not focused in the interaction with the user.
...
\cite{epstein1996growing} an environment based in {\em Sugarscape}~\cite{sugarscape}, 
...
relations of rivalry (friction) and cooperation (synergy). In other ste of our methodology, the actions of the agents are parametrized according the work of Nairat
