...
Starting from this incomplete language, the user has to define the expressions:
\begin{itemize}
\item \textbf{<date>}: Should be expressed in a way that is meaningful to the type of background that we are looking for.\\
For example, if we are talking about persons, it could be the age of the agent expressed in days.
...
For example, if we are trying to find archetypes about love like the classical Romeo and Juliet archetype, where two characters that are in love, their families are in war and finally ends up with their death, we should include actions and relations like ``loves'', ``hates'', ``is son of'', ``is daughter of'', ``is parent of'', ``die'', etc.\\
As a recommendation, the smallest the group of possible actions is, the easiest would be to find out the archetypes.
...
The backstory generated by each agent using the language modeled this way will be automatic and human readable.


\subsubsection{Modeling of the literary setting}

%TODO Qué se desea
%TODO Expresar cada arquetipo en base al lenguaje generado 
%TODO Genérico
%TODO Etiquetar agentes y entorno según arquetipos y tropos
%TODO el agente es independiente del setting. El setting sólo tiene en cuenta el lenguaje generado
...
An agent, is a %TODO Definición y refs


%TODO Que es un agente -> una simplificación de un personaje
%TODO Se modela como una máquina de estados
%TODO Genera un lenguaje
%TODO ¿Almacena su log personal?
%TODO Describe la vida del personaje

\textbf{The agents' execution environment}

%TODO Es un proceso estocástico
%TODO turno para ejecutarse
%TODO Intercomunicación con otros agentes

\textbf{Modeling the life cycle}

%TODO Selección de la unidad de tiempo
%TODO Variabilidad en la ejecución del agente y directrices estáticas
%TODO Definición de parámetros de ejecución
%TODO Parámetros base y parámetros perfílicos, si esa palabra tiene algún sentido en algún universo.


\subsection{Definition of the GA characteristics}

%TODO Selección de un GA
%TODO mapear los parámetros a un cromosoma
%TODO Definir la función de fitness sobre el lenguaje que modela la ambientación 
%TODO - Función sobre lenguaje generado que permite marcar a los agentes
%TODO - Función sobre el nº de agnetes que cumplen un marcado, para puntuar la solución
%TODO Definir nº de perfiles (por qué)
...
%TODO Lanzar GA
%TODO Obtener el mejor fitness
%TODO Lanzar una ejecución del entorno
