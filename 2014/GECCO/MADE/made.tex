...
\title{A general methodology for designing emergent literary backstories on secondary characters using genetic algorithms}
...
presents a general methodology to generate cohesive and coherent
backstories where desired archetypes can emerge in complex stochastic systems, mainly for virtual environments, using a Genetic Algorihm
(GA). This methodology supports the modeling and parameterizing of the agents, the environment where they will live and the desired setting. The usage of a genetic algorithm is proposed to establish the parameter configuration that will lead to backstories that best fit the setting. Information extracted from a simulation can then be used to create the literary work.
...
%FERGU: HABLAR DE LA METODOLOGÃAIA COMO UNA NARRACION
...
. Archeto types allows empathize  % mal escrito, y � FERGU: arreglado. Sí, existe.�existe empathize? - JJ
