...
\begin{abstract}
Evolutionary Algorithms is a computational model based in the natural evolution of the species. However, this metaheuristic does not fit exactly with the natural selection mechanism regarding the survival process. This paper proposes an evolutionary approach based in the fight between individuals, implemented as a selection mechanism, thus avoiding the evaluation and fitness calculation needs. This algorithm has been designed as an optimization method for the parameters of the behavioural engine of bots for the RTS game Planet Wars.
Four different approaches are proposed, namely steady state and generational implementations, each of them considering 1 vs 1 and 1 vs 3 bots combats.
\end{abstract}
