...
% Maribel, Â¿Cuales?, una arquitectura diferente no es un sistema operativo diferente 
% Antonio - nombra las arquitecturas, impementaciones, etc
implementations and evolutionary
algorithms to assess which ones offer most advantages in terms of
performance, scalability and ease of use 
% Maribel, lo de la facilidad de uso no hay forma de medirlo a no ser que sea tu propia intuiciÃ³n o experiencia y no vale a no ser que hayas usado otros lenguajes y otras herramientas
for the computer scientist. All implementations  have been released as open source.
% Antonio - una línea de conclusiones
\end{abstract}
...
\keywords{Javascript, ...}
% Antonio - faltan palabras clave

\section{Introduction}

JavaScript (JS fro now on) was introduced in 1998 as a browser-oriented language by
...
synchronous islands) were not suitable to an ephemerous client that
...
brings errors which crash the clients in some cases (they have been solved for the most part). 
...
We should emphasise too that this research has been carried out in an
