...
\conferenceinfo{EvoSoft @ GECCO'14} {Vancouver, Canada}
\CopyrightYear{2014}
...
% Antonio - qué features en concreto?, al menos nómbralas
...
%Maribel, muchos frameworks van mÃ¡s allÃ¡ del algoritmo genÃ©tico canÃ³nico, pero esto no pasa porque estÃ©n hechos en javascript
% Antonio - qué cambio en concreto?
...
that uses classes and objects, functions as first-rate types and
...
become what it is now, one of the most (or arguably the most) popular development languages
...
% Antonio - ¿qué significa que sea asincrono?
...
it also a different way of understanding the algorithm
sequence. Please note that {\tt do\_after\_callbacks} receives a
function {\em pointer}, not a function call; it is not a recursive
...
\begin{figure}[htb]
\centering
   \includegraphics[scale=0.35]{base-hits-pop.png}
...
\begin{figure}[htb]
\centering
   \includegraphics[scale=0.35]{base-time-pop.png}
...
\begin{figure}[htb]
\centering
   \includegraphics[scale=0.30]{benchmark.png}
...
\begin{figure}[htb]
\centering
   \includegraphics[scale=0.35]{parallel-hits-pop.png}
...
\begin{figure}[htb]
\centering
   \includegraphics[scale=0.35]{parallel-time-pop.png}
...
\begin{figure}[htb]
\centering
   \includegraphics[scale=0.35]{par-pool-time-pop.png}
\caption{Average time, in milliseconds, for successful runs. Black,
...
\begin{figure}[htb]
\centering
   \includegraphics[scale=0.35]{par-pool-hits-pop.png}
\caption{Number of successful runs out of 30. Black, solid line
