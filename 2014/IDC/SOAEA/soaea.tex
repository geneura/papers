...
Service Oriented Architecture (SOA)  is a possible solution to deal
with these shortcomings in development, integration, standardization and dynamism. % ¿Cuáles? ¿El que existan muchos frameworks?
                         % ¿Lo ves como no está clara la línea
                         % argumental? Sólo ha quedado claro un
                         % "shortcoming" (que, además, no has
                         % justificado) -JJ FERGU reescrita la intro. Quería que los shortcomings sean los 4 esos, añadidos
...
\cite{Arsanjani2008SOMA}. The elements that combine an EA are
candidate to be designed as services, as they can behave as
input/output functions. Also, SOA could help to solve the problems
previously addressed: % addressed o exposed? No los has expuesto - JJ FERGUSON: ahora sí
...
\item {\em Standardization}: Interfaces of services use public
  ...
  \cite{Foster2005Science}, SOA is the key to develop Open Science. % a ver si es verdad, pero lo veo complicado Es un buen argumento, de todas formas, igual tendrías que empezar por ahí. - JJ FERGU: ya, pero ya es meterse a saco en otro área. Pero me lo apunto como idea para siguientes papers.
...
%\begin{tabular}{|c|c|c|}
%\hline
% marca los mejores, pon también en el pie cuando son significativos y
% pon un gráfico para qeu se vea claro, que con tanto número no se ve
% nada claro. - JJ
...
% Son pocas pruebas, habría que hacer alguna más y sobre todo con
% diferentes tamaños de problema - JJ
