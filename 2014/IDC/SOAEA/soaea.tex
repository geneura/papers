...
% ¿Cuál es el máximo? Si son 10 páginas, tienes que recortar - JJ
...
% "subtypes" - JJ
 ...
 and two different combinations can yield two different algorithms. % este  párrafo tiene obviedades, puede eliminarse - JJ
...
with these shortcomings. % ¿Cuáles? ¿El que existan muchos frameworks?
...
previously addressed: % addressed o exposed? No los has expuesto - JJ
...
\item {\em Standardization}: Interfaces of services use public
  ...
  \cite{Foster2005Science}, SOA is the key to develop Open Science. % a ver si es verdad, pero lo veo complicado Es un buen argumento, de todas formas, igual tendrías que empezar por ahí. - JJ
...
%valgo. Sólo te falta el "Regarding to" - JJ
