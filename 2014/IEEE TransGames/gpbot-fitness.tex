...
The algorithm presented in \cite{} % ¿El algoritmo de la anterior
                              % generación? ¿Eso qué es? - JJ FERGU: cierto, lo quito
...
match of the individuals in a real-scenario, 
which explains the title we have given to this paper.  % Esta frase casi que la quitaría  [Pedro]
Selection of the mating parents is performed in a battle: the winner is selected to crossover and the loser will be removed from the population (as it will be explained later).
