...
Two different types of battles will be compared: {\em 1vs1} and {\em 4vs4}, as they are the only possible match types in Planet Wars. In both configurations the winner will be selected to mating and the loser (i.e. the first to be eliminated) will be removed from the population. Therefore, in the case of 4vs4, the individuals ending in 2nd and 3rd position neither are selected for mating nor removed.
