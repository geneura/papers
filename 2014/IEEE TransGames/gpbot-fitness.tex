...
% Antonio - poner un enlace mejor que este que he encontrado. ;)
...
The problem in this paper is to create a bot's AI in order to win the game, i.e. able to defeat every possible opponent in a 1 vs 1 or 4 vs 4 match (four independent bots fighting in the same map). %TODO quitar esto dependiendo de lo que se use
...
\label{fig:javatree}
\caption{Example of a generated decision tree.}
% Antonio - más que un decision tree es un rule-based system, no?
% Antonio - Si queremos hablar de decision trees, se podría dibujar uno modelando esas reglas. ;)
\end{figure}
...
Two different types of battles will be compared: {\em 1vs1} and {\em 4vs4}, 
% Antonio - esto lo ponía yo mal también, no son combates 4 contra 4, sino 1vs3. ;D
as they are the only possible match types in Planet Wars. In both configurations the winner will be selected to mating and the loser (i.e. the first to be eliminated) will be removed from the population. Therefore, in the case of 4vs4, the individuals ending in 2nd and 3rd position neither are selected for mating nor removed.
...
\WHILE{stop criterion not found}
  ...
  \FOR{1 to N}
    \STATE //2 contenders in 1vs1 and 4 contenders in 4vs4
% Antonio - lo del 4vs4
...
% Antonio - Si no se quiere hacer dos pseudocódigos para 1vs1 y para 1vs3, se pueden poner cosas comentadas sobre quienes son winner1 y loser1 en cada caso, poner algunas líneas que sólo se ejecutarían en un caso o en otro, etc
