...
\tiny
\begin{center}
    \includegraphics[width=9cm]{./imags/noise_study.eps}
   
\end{center}
\caption{Noise of the best A and B in multiple simulations equal (same map and opponent).}
\label{figura:noise_study.eps}
\end{figure}
