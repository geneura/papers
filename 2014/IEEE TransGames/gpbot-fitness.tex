...
The used Decision Trees are binary trees of expressions composed by two different \textit{types of nodes}:
...
Maps used in each evaluation & 1 random from maps \#76 \#69 \#7 \#11 \#26\\ \hline
\end{tabular}
