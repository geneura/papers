...
\author{Rubén H. García \inst{2} J.J. Merelo\inst{1} \and  Pablo García-Sánchez\inst{1} \and A.M. Mora\inst{1}  } 

\institute{University of Granada\\
       Department of Computer Architecture and Technology, ETSIIT\\
       18071 - Granada\\
       \email{\{jmerelo,pgarcia,amorag\}@geneura.ugr.es}
\and
Fidesol\\
...
Given a set of states, properties and actions modelled, the logic of the main process should be:
...
The MADE environment can be configured by using the following parameters (with the values that will be used in the experimental section): Number of agents initially placed (15), map square grid dimension (10), number of rations randomly placed in the grid each day (10) and duration in virtual days of the  execution of the environment (1000). These parameters can affect directly to the behavior of the agents.
