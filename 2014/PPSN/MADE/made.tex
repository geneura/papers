...
\author{Rub�n H. Garc�a \inst{2} J.J. Merelo\inst{1} \and A.M. Mora\inst{1}  \and  Pablo Garc�a-S�nchez\inst{1}} 

\institute{University of Granada\\
       Department of Computer Architecture and Technology, ETSIIT\\
       18071 - Granada\\
       \email{\{jmerelo,amorag,pgarcia\}@geneura.ugr.es}
\and
Fidesol\\
...
the following subsections, and finally interpretation. % No forma
                                % parte del paper, as� que lo he
                                % eliminado JJ PPSN



\subsection{Modeling} % Las subsecciones habr�a que eliminarlas para
...
\item \textbf{<action\_id>}: Different actions can be taken into
  ...
  ``die'', etc. % Tienes demasiado ejemplos. Y no se usa etc - JJ PPSN
...
have been modeled in the MADE agent for this study. % �Si no hay
