...
\title{Peer to Peer Evolutionary algorithms in JavaScript}
\subtitle{}

\author{J.J. Merelo\inst{1}  \and Pedro Castillo\inst{1}  \and Antonio
  Mora\inst{1}  \and Anna I. Esparcia-Alcázar\inst{2} \and Víctor Rivas\inst{3}}
...
programming. 
% destacar también la portabilidad entre todas las plataformas [Pedro]
...
interpreter and its adoption by  {\tt node.js} 
% una URL a pie de página o una cita para el node.js vendía bien [Pedro] 
that it started to become what it is now, one of the most popular development languages
...
choice for parasitic-style 
% cita a tus propios trabajos, JJ, sobre computación parásita [Pedro] 
or volunteer computing platforms such as
...
% JJ, ¿de los experimentos y demás que hiciste sobre computación parásita (se usaba el navegador, y supongo que JS), y que discutiste en tu cátedra, no hay publicaciones para citarlas? [Pedro] 
...
between them; 
% si no se hace así, ¿qué puede pasar? [Pedro] 
however, this concerns mainly the design of library {\em
...
% Antonio - de aqui hacia abajo podría ir en la sección de experimentos.
...
% Antonio - he puesto aquí pool architecture en lugar de other architecture
 with clients all working against a single server. In principle we wanted to
...
% ¿no lo comentaría o sí lo comentaría?  :)   [Pedro] 
...
%This work has been developed thanks fo the funding by the Spanish Science Ministry ANYSELF (TIN2011-28627-C04-02). 

This work has been supported in part by project ANYSELF (TIN2011-28627-C04-02).
...
% poner los logos del SIPESCA (exigencia de la AOPA). Te los paso por email.   [Pedro]
