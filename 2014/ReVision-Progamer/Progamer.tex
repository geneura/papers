...
\caption{El mismo programa de la figura  diseñado con Scratch. 
\label{fig:alice}}
\end{center}
\end{figure}
...
sus estudiantes cómo funcionaba. La metáfora consiste en que dentro
del ordenador viven pequeñas personas (PPs) que son especialistas en
...
implementado un {\em listener'} % usa cursiva para palabras en inglés
