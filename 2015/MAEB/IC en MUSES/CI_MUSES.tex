...
% Primero: ¿Anna no participa? ¿Ni Sergio? Segundo ¿no hay nada mejor que sistemas de seguridad? ¿No sería, al menos, ciberseguridad? Sistemas de seguridad es para que no se metan los cacos - JJ

\author{P. De las Cuevas, A.M. Mora, J.J. Merelo \thanks{Departamento de Arquitectura y Tecnología de Computadores. CITIC, ETSIIT,Universidad de Granada
E-mail: \{paloma,amorag,jmerelo\}@geneura.ugr.es}}

\maketitle

% ¿Qué quieres hacer? ¿Cuál es el objetivo? ¿Con qué motivación? ¿Qué
% resultados nuevos o enfoque nuevo presentas en este trabajo? ¿Por
% qué tendría que interesarle al lector? - JJ
\begin{abstract}
% ``en development'' suena a excusa y no aporta ninguna
% información. Igual que ha dicho Anna del capítulo de libro, lo que
% hay que presentar es el problema y la solución, no el proyecto. El
