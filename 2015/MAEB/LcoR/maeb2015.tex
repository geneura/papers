...
que cooperarán en un entorno distribuido logrando mejorar las soluciones usando un enfoque colaborativo. Estos trabajos se enmarcan dentro de una línea de investigación ya iniciada en Rivas et al. \cite{EvoStar2014:jsEO} y Merelo et al. \cite{DBLP:conf/gecco/GuervosVGES14}, y permitirán la descentralización del proceso de creación de los modelos predictores al mismo tiempo que la difusión de los mismos a los dispositivos interesados en explotarlos.
